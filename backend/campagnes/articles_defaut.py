...
Repris tels quels de App\Models\CampagneContratArticle : ce sont des clauses
contractuelles signées par les commerciaux, leur formulation ne doit pas varier
d'un caractère entre les deux stacks.
"""
...
def articles_par_defaut(type_campagne):
    """Jeu d'articles correspondant au type de campagne."""
    if type_campagne == "enrolement_app":
        return ARTICLES_ENROLEMENT_APP
    return ARTICLES_VENTE_CARTE
